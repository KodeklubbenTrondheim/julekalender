    ...
    this.appendDummyInput()
      ...
      .appendField(
        new Blockly.FieldDropdown([
          [
            { src: process.env.PUBLIC_URL + '/images/helvetica.png', width: 100, height: 28, alt: 'Helvetica' },
            'Helvetica',
          ],
          [
            { src: process.env.PUBLIC_URL + '/images/comic-sans-ms.png', width: 90, height: 28, alt: 'Comic Sans MS' },
            'Comic Sans MS',
          ],
          [
            {
              src: process.env.PUBLIC_URL + '/images/handwritten.png',
              width: 120,
              height: 28,
          ...
          [
            { src: process.env.PUBLIC_URL + '/images/monospace.png', width: 100, height: 28, alt: 'Monospace' },
            'Monospace',
          ],
        ]),
        'NAME'
...
Blockly.Blocks['fonttype'] = {
  init: function () {
    ...
    this.appendDummyInput()
      ...
      .appendField(
        new Blockly.FieldDropdown([
          [{ src: process.env.PUBLIC_URL + '/images/normal.png', width: 60, height: 24, alt: 'normal' }, 'normal'],
          [{ src: process.env.PUBLIC_URL + '/images/bold.png', width: 60, height: 24, alt: 'bold' }, 'bold'],
          [{ src: process.env.PUBLIC_URL + '/images/italic.png', width: 60, height: 24, alt: 'italic' }, 'italic'],
        ]),
        'TYPE'
      )
    this.setPreviousStatement(true)
